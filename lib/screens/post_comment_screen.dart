...
class PostCommentLayout extends StatefulWidget {
  ...
  const PostCommentLayout(
      ...
      required this.uid,
      required this.userName, required this.isSub});
...
class _PostCommentLayoutState extends State<PostCommentLayout> {
  ...
  void refreshSubNumberOfComment() {
    Provider.of<PostsProvider>(context, listen: false).refreshSubNumberOfComment();
  }
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if(widget.isSub) {
                                for(var i = 0; i < Provider.of<PostsProvider>(context, listen: false).postData!.length; i++) {
                                  if(Provider.of<PostsProvider>(context, listen: false).postData![i].toString() == Provider.of<PostsProvider>(context, listen: false).subPostData[0].toString()) {
                                    Provider.of<PostsProvider>(context, listen: false).postIndex = i;
                                    refreshNumberOfComment();
                                    print("donne");
                                  }
                                }
                                refreshSubNumberOfComment();
                              } else {
                                refreshNumberOfComment();
                              }
